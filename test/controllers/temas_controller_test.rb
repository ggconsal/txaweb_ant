...
class TemasControllerTest < ActionController::TestCase
  ...
  test "should create tema" do
    assert_difference('Tema.count') do
      post :create, tema: { area_id: @tema.area_id, tem_desc: @tema.tem_desc, tem_titulo: @tema.tem_titulo }
    end
  ...
  test "should update tema" do
    patch :update, id: @tema, tema: { area_id: @tema.area_id, tem_desc: @tema.tem_desc, tem_titulo: @tema.tem_titulo }
    assert_redirected_to tema_path(assigns(:tema))
  end
